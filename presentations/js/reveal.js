...
(function( root, factory ) {
	...
	var SLIDES_SELECTOR = '.slides section',
		...
		keyboardShortcuts = {
			'A':                    'Toggle Application Mode (Screen Readers)',
			'N  ,  SPACE':			'Next slide',
			'P':					'Previous slide',
			'&#8592;  ,  H':		'Navigate left',
			'&#8594;  ,  L':		'Navigate right',
	...
	function toggleApplication() {
		if (dom.wrapper.hasAttribute('role')){
			dom.wrapper.removeAttribute( 'role');
		}
		else{
	...
	function slide( h, v, f, o ) {
		...
		if( previousSlide ) {
			...
			previousSlide.setAttribute( 'hidden','');
		...
		horizontalSlides.forEach( function( horizontalSlide ) {
			...
			verticalSlides.forEach( function( verticalSlide, y ) {
				...
				if( y > 0 ) {
					...
					verticalSlide.setAttribute( 'hidden', '' );
	...
	function onDocumentKeyDown( event ) {
		...
		if( triggered === false ) {
			...
			switch( event.keyCode ) {
				case 65: toggleApplication(); break;
				// p, page up
